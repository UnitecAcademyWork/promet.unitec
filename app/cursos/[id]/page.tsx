...
const CursoCandidatura = () => {
  ...
  const passosAposCandidatura = [
    {
      ...
      descricao: "Nossa equipe analisará a sua candidatura e poderás controlar o processo no seu Perfil",
    ...
    },
    {
      ...
      descricao: "Após a aprovação no teste, será informado sobre a data do início da formação",
  ...
  useEffect(() => {
    const fetchCurso = async () => {
      try {
        const response = await fetch(`https://backend-promet.unitec.academy/curso/${params.id}`);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Curso não encontrado</h2>
          <button 
            onClick={() => router.back()}
  ...
  const dataInicio = curso.dataInicio ? new Date(curso.dataInicio).toLocaleDateString("pt-BR") : "A definir";
  const dataFim = curso.dataFim ? new Date(curso.dataFim).toLocaleDateString("pt-BR") : "A definir";
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden p-6 mb-6">
          ...
          <div className="flex flex-wrap gap-4 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            <div className="flex items-center text-sm">
              ...
              <span className="text-gray-600 dark:text-gray-300">Início: {dataInicio}</span>
            </div>
            <div className="flex items-center text-sm">
...
{/* Processo após candidatura */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
          <h2 className="text-xl font-bold text-brand-main dark:text-white mb-6 text-center">Processo Após a Candidatura</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {passosAposCandidatura.map((passo, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-5 flex flex-col items-center text-center">
                <div className="w-12 h-12 bg-brand-main/10 rounded-full flex items-center justify-center mb-3 text-brand-main">
                  {passo.icone}
                </div>
                <h3 className="font-semibold text-gray-800 dark:text-white mb-2">{passo.titulo}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 h-full">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Benefícios do Curso</h3>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 h-full">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Vantagens para Você</h3>
            </div>
            <ul className="space-y-3">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 h-full">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Requisitos de Inscrição</h3>
            </div>
            <ul className="space-y-3">
            ...
            <ul className="mt-2.5 space-y-3">
                ...
                <li className="flex items-start" >
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-300">Interesse pela área de {curso.nome}</span>
                </li>
            </ul>
          </div>
        </div>
